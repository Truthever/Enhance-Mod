...
public class SacrificeTrigger extends AbstractCriterionTrigger<SacrificeTrigger.Instance> {
    private static final ResourceLocation ID = new ResourceLocation("enhance", "sacrifice");
    @Override
    ...
    public static class Instance extends CriterionInstance {
        public Instance(EntityPredicate.AndPredicate player) {
            super(SacrificeTrigger.ID, player);
        }
        @Override
