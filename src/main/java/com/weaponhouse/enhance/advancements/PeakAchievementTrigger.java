...
public class PeakAchievementTrigger extends AbstractCriterionTrigger<PeakAchievementTrigger.Instance> {
    private static final ResourceLocation ID = new ResourceLocation("enhance", "peak_achievement");
    @Override
    ...
    public static class Instance extends CriterionInstance {
        public Instance(EntityPredicate.AndPredicate player) {
            super(PeakAchievementTrigger.ID, player);
        }
        @Override
