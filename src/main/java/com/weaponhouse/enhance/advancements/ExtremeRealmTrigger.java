...
public class ExtremeRealmTrigger extends AbstractCriterionTrigger<ExtremeRealmTrigger.Instance> {
    private static final ResourceLocation ID = new ResourceLocation("enhance", "extreme_realm");
    @Override
    ...
    public static class Instance extends CriterionInstance {
        public Instance(EntityPredicate.AndPredicate player) {
            super(ExtremeRealmTrigger.ID, player);
        }
        @Override
