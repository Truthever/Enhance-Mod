...
public class DefenseReductionEffect extends BaseEffect {
    private static final UUID DEFENSE_MODIFIER_UUID = UUID.fromString("00000000-0000-0000-0000-000000000011");
    ...
    private void applyAttributeModifier(ModifiableAttributeInstance attribute, UUID uuid, double amount, AttributeModifier.Operation operation) {
        ...
        AttributeModifier newModifier = new AttributeModifier(uuid, "defense_reduction", amount, operation);
